...
- Business sender email: **mehdi@seawaysites.com** (canonical as of 2026-07-20, per commit `22b87d3`). Old `hello@seawaysites.com` is retired; do not grep for it. Updated in 8 source files: app/page.tsx, app/api/leads/route.ts, app/_landing/V2Landing.tsx, app/privacy/page.tsx, app/llms.txt/route.ts, scripts/send-outreach/templates.ts, .env.local. Vercel-env verification still pending (see AGENT_PLAN.md J.4).
