...
<div class="watermark">Seaway Sites Variant {variant_num} Preview</div>
        ...
        new_proto = {
            ...
            "generation_prompt": f"Use docs/PROTOTYPE_GENERATION_PLAYBOOK.md and the frontend-skill + premium-saas-design skills. Variant {variant_num}: {template['name']} design system",
