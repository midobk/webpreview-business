#!/usr/bin/env python3
"""One-off: generate the He & She Hairstyling prototype HTML via local Ollama."""
...
OUT_DIR = "/home/clawuser/.openclaw/workspace/webpreview-business/data/prototypes/he-and-she-hairstyling-2"
LEAD = {
    "business_name": "He & She Hairstyling",
    "slug": "he-and-she-hairstyling-2",
    "industry": "barber",
    "city": "Cornwall",
    "province": "Ontario",
    "country": "Canada",
    "address": "1140 Brookdale Ave, Cornwall, ON K6J 4P4",
    "phone": "+1 613-932-7718",
    "description": "Local hairstyling salon serving Cornwall, Ontario — a neighbourhood spot for cuts, colour, and styling.",
}

# Shorter, focused system prompt to avoid excessive prefill on a long context
...
# Use a clean, well-bounded prompt to minimize reasoning leakage
PROMPT = f"""Build the full <body> for a single-page local-business site.

Business facts (use ONLY these, do not invent):
- Name: {LEAD['business_name']}
- Industry: {LEAD['industry']} (unisex hair salon)
- City: {LEAD['city']}, {LEAD['province']}, {LEAD['country']}
- Address: {LEAD['address']}
- Phone: {LEAD['phone']}
- Description: {LEAD['description']}

Page job: get the visitor to call the salon to book. Primary CTA = "Call {LEAD['phone']}".
...
3. <header class="nav"> with the business name as a serif wordmark and a CTA "Call to book" with onclick="alert('Claim this website to unlock the live version'); return false;"
4. <section class="hero"> with hero image './images/hero.jpg', a serif h1 with one italic-amber <em> word, a short tagline (no marketing fluff), and a primary CTA "Call to book" with the same demo-locked onclick. Add a small "1140 Brookdale Ave · Cornwall" line.
5. <section class="services"> with the signature service list (item names, dotted leaders, prices). 4 honest service categories: Haircut, Colour, Wash & Style, Beard Trim. Modest honest prices (e.g. $28, $45, $85, $18 — not round). Tabular numerals, brass dotted leaders.
6. <section class="craft"> with image './images/craft.jpg' and 2-3 sentences about what a visit feels like. No fake stats.
7. <section class="visit"> with image './images/storefront.jpg', the address, the phone, and "Walk-ins welcome. Call ahead to book." CTA is demo-locked.
8. <section class="hours"> honest hours: Tue–Fri 9:00–17:30, Sat 9:00–15:00, Sun & Mon closed.
9. <footer> with "Concept by Seaway Sites · Demo Preview" and a demo-locked "Claim this website" link.
