...
- **Required reading:** `docs/PROTOTYPE_GENERATION_PLAYBOOK.md`, `docs/PROTOTYPE_QA.md`, `docs/PROTOTYPE_RULES.md`, `docs/SHOWCASE_RULES.md`, plus the vendored `.agents/skills/premium-web-design`, `.agents/skills/frontend-craft`, and `.agents/skills/color-expert` skills.
