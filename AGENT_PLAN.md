...
- [ ] **PR #18 — `codex/g8-landing-conversion`** "G8: tighten the landing conversion path" — opened 2026-07-22 01:20 UTC, still OPEN. Not previously recorded. **Acceptance:** `gh pr view 18` to inspect diff (likely CTA copy, form friction reduction, or above-the-fold layout changes — the agent's "G8" naming suggests it's part of the conversion-rate work); confirm pricing still matches §3 (J.3 resolved 2026-07-22 — §3 was rewritten to match `app/_landing/content.ts`) before merging.
