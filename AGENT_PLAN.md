...
### Packages (live pricing — mirrors `app/_landing/content.ts` `PRICING`, verbatim as of 2026-07-22)

| Package | Price | Includes |
|---------|-------|----------|
| **Free Draft** | Free — one personalized first draft | Complete one-page initial draft, mobile + desktop direction, personalized copy and visual palette, quality-checked before delivery, no card and no obligation |
| **Managed Website** | $399 setup + $69/mo · early-client pricing | Draft refined to production-ready, custom domain connection + SSL, hosting and technical maintenance, two small content-update requests per month, cancel anytime |
| **Own Your Website** | $899 paid once · source files included | Production-ready one-page website, full source files, domain and hosting guidance, 30 days of bug-fix support, no recurring Seaway Sites fee |
| **Custom Quote** | TBD | Ecommerce, booking, payments, multi-page, integrations, backend — out of MVP scope (§2), quoted separately |

All prices CAD (per the site footer disclosure). Free Draft is the pre-reply hook, not a post-reply upsell — it's already been delivered by the time a prospect responds. Managed Website and Own Your Website are the two paid choices to discuss once they reply.

### Principle
Managed-by-default = recurring revenue. Own Your Website costs more upfront because there's no default recurring support relationship.
...
#### J.3. ~~PRICING DRIFT — active landing diverges from §3~~ — RESOLVED 2026-07-22
- [x] **Reconcile `app/_landing/content.ts` pricing with §3 Packages table** — **User decision: option (b)** — adopt the live landing numbers into §3 verbatim; `app/_landing/content.ts` is the source of truth and was left untouched. §3 Packages table rewritten to match `app/_landing/content.ts` `PRICING` exactly: **Free Draft** (Free) / **Managed Website** ($399 setup + $69/mo · early-client pricing) / **Own Your Website** ($899 paid once · source files included). The old §3 names/numbers — **Managed Starter** ($299–399 + $49/mo), **Standard** ($500 one-time), **Full Handoff** ($700–900 one-time) — are retired; **Standard** had no live-site equivalent at all and is dropped rather than remapped. §3's "Principle" line updated to reference **Own Your Website** instead of the retired **Full Handoff** name. MEMORY.md C4 updated in the same turn per the "Rules Going Forward" pairing rule (§141-146). Outreach templates (`scripts/send-outreach/templates.ts`) checked — no hardcoded pricing found, nothing to reconcile there. PR #4's stale "confirm pricing still matches §3" checklist item is moot (PR #4 already merged 2026-07-21 — see J.1).

#### J.6. ~~Pricing drift — additional touch points~~ — RESOLVED 2026-07-22 (see J.3)
- [x] **Triage the 3 new commits since 7/21 that touch (or relate to) the divergent pricing** — resolved as part of J.3. `918763b`'s "sender + pricing" change is confirmed intentional: it's the same $399 setup + $69/mo / $899 numbers already live in `app/_landing/content.ts`, now adopted into §3 — no revert needed. `dfab6c6` (Meta-ads attribution) and `c903548` (Vercel prototype-HTML fix) were operational and independent of the pricing decision; no further action needed on either.
